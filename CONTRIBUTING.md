...
[![GoDoc](https://godoc.org/github.com/rovandep/machine?status.png)](https://godoc.org/github.com/rovandep/machine)
[![Build Status](https://travis-ci.org/rovandep/machine.svg?branch=master)](https://travis-ci.org/rovandep/machine)
[![Windows Build Status](https://ci.appveyor.com/api/projects/status/github/rovandep/machine?svg=true)](https://ci.appveyor.com/project/dmp42/machine-fp5u5)
[![Coverage Status](https://coveralls.io/repos/rovandep/machine/badge.svg?branch=master&service=github)](https://coveralls.io/github/rovandep/machine?branch=master)
...
Example of cloning and preparing the correct environment `GOPATH`:
    ...
    $ cd docker-machine
    $ export GOPATH="$PWD"
    $ go get github.com/rovandep/machine
    $ cd src/github.com/rovandep/machine
...
the directory that contains your `src` directory, e.g.:
    ...
    $ cd $GOPATH/src/github.com/docker && git clone git@github.com:rovandep/machine.git
    $ cd machine
